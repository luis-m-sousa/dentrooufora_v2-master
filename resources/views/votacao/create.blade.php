        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    <h3>Registro de Votação</h3>
                    <p>Preencha os campos abaixo.</p>
                    <form class="requires-validation" method="POST">
                        @csrf
                        <div class="col-md-12 pb-3">
                           <input class="form-control" type="text" name="titulo" value="{{ old('titulo') }}"  placeholder="Título" required>
                        </div>
                        <div class="col-md-12 pb-3">
                            <input class="form-control" type="text" name="descricao" value="{{ old('descricao') }}"  placeholder="Descrição">
                         </div>
                         <div class="col-md-12 pb-3">
